...
import net.iubris.hermes.activity.main.listener.HermesMainRoboActivityListener;
...
public class HermesMainRoboActivity<C,HS extends Service & IHermesService<C>> 
...
//implements HermesClient<C>/*, IHermesRoboActivity<HS, C>*/ 
{
	...
	@Inject private HermesMainRoboActivityListener<HS,C> listener;
	//@Inject private HermesConnectorBinder<HS,C> connectorBinder;
