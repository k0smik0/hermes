...
abstract public class HermesRoboService<HS extends Service & IHermesService<C>, C> 
extends RoboService implements IHermesService<C> {
	...
	public void onCreate() {
		super.onCreate();		
		binder = new HermesServiceBinder<HermesRoboService<HS, C>,C>(this);
	}	
