...
abstract public class HermesRoboAsyncTaskSearchAndStartingActivity
/*<Result, 
HA extends IHermesActivity<C, HS>, 
C, 
HS extends IHermesService<C>, A extends Activity>*/
...
extends HermesRoboAsyncTask<Result, HC, C> {
	...
	protected HermesRoboAsyncTaskSearchAndStartingActivity(HC context, Class<A> activityToStartClass) {
		super(context);
