...
<HA extends HermesClient<C>, C> implements OnClickListener {

	protected final HA context;

	public HermesButtonListener(HA hermesActivity) {
		this.context = hermesActivity;
	}
}
