 ...
 ******************************************************************************/
package net.iubris.hermes.activity.splash;
...
extends Activity {
	...
	private IHermesSplashDelegate<A,HS,C> splashActivityDelegate;
	
	/**
	 * milliseconds
	 */
	protected int minWait = 2500;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new SplashThread<A,HS,C>(this, splashActivityDelegate, minWait).start();
	}
	
	protected abstract IHermesSplashDelegate<A,HS,C> getDelegate();
