...
public class HermesClientWrapper<HA extends Application & HermesCoreProvider<HS, C>, HS 
extends Service & IHermesService<C>, C> 
implements HermesClient<C> {

	private final Connector<HS, C> connector;
	private final HA application;
	
	public HermesClientWrapper(HA application, Class<HS> serviceClass) {
